#!/bin/bash
export MY_DB_PATH=$HOME/2016_ITE4065_2012003415/Project3/mariadb/run
export MY_DB_DOC_PATH=$HOME/2016_ITE4065_2012003415/Project3/mariadb/run/doc
export MY_DB_VAR_PATH=$HOME/2016_ITE4065_2012003415/Project3/mariadb/run/var
cmake \
...
#-DCMAKE_CXX_FLAGS=-DPROJECTS_PART2 \
